...
더 찾아보기엔 내 어깨가 버틸 수 없어서 간단히 나는 파이썬 코드로 구현하기로 했다.

[oil-lamp-cat/CVE-2026-29000-pac4j-PoC](https://github.com/oil-lamp-cat/CVE-2026-29000-pac4j-PoC)

![run](https://github.com/user-attachments/assets/efc4c7d2-3383-4ae8-8249-8660623b989a)

Readme에도 나와있듯 실행을 해보면? 위처럼 관리자 권한이 들어간 토큰을 얻을 수 있게 된다.
...
와 진짜... 오랜만에 와서? 갑자기 인증서에 관련된 Medium 문제를 풀어서? 직접 poc를 구현해서?인지 뭔가 엄청 내용이 많아진 듯 하면서도 짧게 푼 것도 같고. 사실 이번 문제는 풀면서 되게 공부를 더 많이 했던 문제였다. 분명히 retired 된 문제여서 writeup이 있기는 한데 그걸 안보고 풀고자 하니 CVE가 어떤 것인지 이해하는 것 부터 poc의 언어가 마음에 안드니 직접 구현까지. 그래도 뭔가 만들고 나니 뿌듯하긴 하다.
